...
int move;
    ...
    //        {
            if (board [row-1] [column]==0 && row >= 0)//up
                ...
                else if (board [column-1] [row]==0 && j > 0) //right
                {
                    move = board [column-1] [row];
                    board [row] [column]=board [row][column];
                    board [row][column=move;
                    return true;
                }
                else if (board [column+1] [row]==0 && j < d) //left
                {
                    move = board [column+1] [row];
                    board [row] [column]=board [row][column];
                    board [row] [row column]=move;
                    return true;
